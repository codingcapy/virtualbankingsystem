...
function RouteComponent() {
  ...
  return (
    <div className="pt-25 pl-62.5 max-w-[95%]">
      ...
      <div className="border border-[#a0a0a0] h-[500px] overflow-y-auto ">
        {profilesLoading ? (
          ...
          data.profiles.map((p) => (
            <Link
              to="/profile/$profileNumber"
              params={{
                profileNumber: p.profileNumber.toString(),
              }}
              className="flex border-b border-[#a0a0a0] cursor-pointer hover:bg-blue-300 transition-all ease-in-out duration-300"
            >
              <div className="w-[100px] p-2 border-r border-r-[#a0a0a0]">
                {p.profileNumber}
              </div>
              <div className="w-[125px] p-2 border-r border-r-[#a0a0a0] overflow-x-hidden">
                {p.firstName}
              </div>
              <div className="w-[125px] p-2 border-r border-r-[#a0a0a0] overflow-x-hidden">
                {p.middleName}
